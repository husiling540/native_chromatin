...
cool_file_path = "/mnt/disk3/hsl/private/data/native_chromatin_Micro-C/20230630_K562_Micro-C_JIACE_BJ_data_analysis/4hicpro/K562_MicroC_allvalidpairs/cooler_res100000"
clr = cooler.Cooler(f'{cool_file_path}/K562_MicroC_{sample_name}.mcool::resolutions/100000')

if not os.path.isfile('/mnt/disk3/hsl/private/pipeline/Hi-C/saddle_plot/hg38.fa'):
    subprocess.call(
        'wget https://hgdownload.cse.ucsc.edu/goldenpath/hg38/bigZips/hg38.fa.gz -O /mnt/disk3/hsl/private/pipeline/Hi-C/saddle_plot/hg38.fa.gz',
        shell=True)
    subprocess.call('gunzip /mnt/disk3/hsl/private/pipeline/Hi-C/saddle_plot/hg38.fa.gz', shell=True)

bins = clr.bins()[:]
hg38_genome = bioframe.load_fasta('/mnt/disk3/hsl/private/pipeline/Hi-C/saddle_plot/hg38.fa');
...
def saddleplot(
    ...
    ax.text(-0.07, 0.2, "active (A)", rotation='vertical', transform=ax.transAxes, ha='center', va='center',
            fontsize=15, color='black')
    ax.text(-0.07, 0.8, "inactive (B)", rotation='vertical', transform=ax.transAxes, ha='center', va='center',
            fontsize=15, color='black')
